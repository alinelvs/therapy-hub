...
describe('LoginComponent', () => {
  ...
  describe('login()', () => {
    ...
    it('should navigate to specialists when authenticated', () => {
      ...
      jest.spyOn(authService, 'authenticate').mockReturnValue(of('success'));
    ...
    it('should rebuild form and not navigate if authentication is invalid', () => {
      jest.spyOn(router, 'navigateByUrl');
      jest.spyOn(authService, 'authenticate').mockReturnValue(of('invalid'));
    ...
    it('should handle authentication error', () => {
      ...
      jest.spyOn(authService, 'authenticate').mockReturnValue(throwError(() => new Error('Authentication error')));
    ...
    it('should not call authenticate if email or password is missing', () => {
